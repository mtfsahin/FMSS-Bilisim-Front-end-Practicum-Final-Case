...
const Card = ({ title, subtitle }) => {
    return (
        <div class="w-60 mt-7 transition-all duration-100 rounded-3xl overflow-hidden bg-primary-950 
            ...
            <div className='hover:text-secondary-400 text-secondary-50 transition-all duration-300 '>
                ...
                <div className="px-6 py-3 bg-primary-950">
                    ...
                    {/* Functional area  */}
                    <div className="flex  justify-center text-primary-100 text-md font-bold ">{title}</div>
                    {/* Functional area  */}
                    <p className="flex justify-center text-primary-100  text-sm">{subtitle}</p>
                    {/* Functional area */}
